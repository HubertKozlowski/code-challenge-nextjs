...
const articleMockGenerator = (props?: Partial<Article>): Article => {
  return ({
    ...
    description: props?.description || 'Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit. Exercitation veniam consequat sunt nostrud amet.',
...
export const ARTICLES_MOCK: Article[] = [
  ...Array(5)
    .fill(undefined)
    .map((_, index) => articleMockGenerator({ 
      id: index.toString(), 
      slug: 'article-slug' 
    })),
]
